...
class Grid:
    ...
    def get_neighbors(self, tile):
        ...
        for pos in range(8):
            hasValidNeighbor = (not (tile.raw_x + x_offsets[pos] < 0) and not (tile.raw_x + x_offsets[pos] > max_x)) and (not (tile.raw_y + y_offsets[pos] < 0) and not (tile.raw_y + y_offsets[pos] > max_y))
